...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, SocialService socialService, JdbcTokenStore jdbcTokenStore, AuthorityRepository authorityRepository, CacheManager cacheManager) {
